...
void UIMainWindow::createToolBars()
{
...
void UIMainWindow::readSettings()
{
...
void UIMainWindow::writeSettings()
{
    QSettings settings("Software Inc.", "Spreadsheet");
...
bool UIMainWindow::okToContinue()
{
    if (isWindowModified()) {
...
bool UIMainWindow::loadFile(const QString &fileName)
{
...
bool UIMainWindow::saveFile(const QString &fileName)
{
...
void UIMainWindow::setCurrentFile(const QString &fileName)
{
    curFile = fileName;
...
void UIMainWindow::updateRecentFileActions()
{
...
QString UIMainWindow::strippedName(const QString &fullFileName)
{
